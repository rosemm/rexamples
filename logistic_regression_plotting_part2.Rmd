# Plotting the results of your logistic regression Part 2: Continuous by ccontinuous interaction
...
It's kinda weird to plot your models at values that don't actually exist in your data (cue Twighlight Zone music).
...
In this case, lots of it will just drop out because I'll be plugging in 0's for all of the dummy codes, but I encourage you to keep the terms in your code, so you don't forget that all of those predictors are still in your model, you're just holding them constant while you plot.
...
The plot will show us the interaction between X1 and X2 for the reference group (and since we didn't allow a 3-way interaction between X1, X2, and group, the X1 by X2 interaction will look the same in each group -- for 3-way interactions, you'll have to wait for part 3!)
